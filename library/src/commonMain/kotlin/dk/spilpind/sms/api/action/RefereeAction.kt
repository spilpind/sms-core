...
sealed class RefereeAction : ContextAction() {
     ...
     * for [Event.Points] and [Event.PenaltyPoint]. Depending on state of the game (see
     * [RefereeReaction.Updated.gameState]) only certain event types are allowed to add. A successful response to this
