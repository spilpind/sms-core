...
val generateVersionInfo by tasks.registering {
    ...
    val outputDirectory = layout.buildDirectory.dir("generated/version/commonMain/kotlin")

    inputs.property("version", versionString)
    outputs.dir(outputDirectory)

    doLast {
        val versionInfoSource = buildVersionInfoSource(versionString)

        val packageDirectory = outputDirectory.get().asFile.resolve("dk/spilpind/sms")
        packageDirectory.mkdirs()

        val versionInfoFile = packageDirectory.resolve("VersionInfo.kt")
        versionInfoFile.writeText(versionInfoSource)
    }
}
...
private fun buildVersionInfoSource(version: String): String = """
    // Auto-generated by the generateVersionInfo Gradle task. Do not edit.
    package dk.spilpind.sms

    /**
     * Version of the current SMS core. Useful e.g. when logging what's used
     */
    const val SMS_CORE_VERSION = "$version"
